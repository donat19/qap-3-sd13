public class Triangle extends Shape {
    ...
    public void scale(double factor) {
        ...
        this.b *= factor;
        this.c *= factor;
        // No need to validate after scaling as the triangle inequality is preserved
        // If the original triangle was valid, scaling all sides by the same factor keeps it valid
    }
